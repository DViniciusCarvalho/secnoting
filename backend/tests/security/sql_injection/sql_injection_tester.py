...
@router.get("/login-sql-injection")
def do_injection(request: Request):
    test_sql_injection()
...
def test_sql_injection():
    ...
    def test_queries(email, password, login_button):
        try:
            with open("backend/tests/security/sql_injection/query_wordlist.txt") as wordlist:
                words = wordlist.read()
